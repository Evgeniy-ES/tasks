module Menu
  ...
  def get_menu_station
    ...
    puts "Если вы хотите запустить метод instances_class нажмие     - 5"
    puts "Если вы хотите запустить метод instances_method нажмие    - 6"
  ...
  def get_menu_routes
    ...
    puts "Если вы хотите запустить метод instances_class нажмие     - 2"
    puts "Если вы хотите запустить метод instances_method нажмие    - 3"
    puts "Для выхода из меню, нажмите - 0"
    puts "============================================================"
    gets.chomp.to_i
  end
  ...
  def get_menu_train
    ...
    puts "Если вы хотите запустить метод instances_class нажмие    - 6"
    puts "Если вы хотите запустить метод instances_method нажмие   - 7"
    puts "Для выхода из меню, нажмите                        - 0"
    puts "============================================================"
    gets.chomp.to_i
  end
